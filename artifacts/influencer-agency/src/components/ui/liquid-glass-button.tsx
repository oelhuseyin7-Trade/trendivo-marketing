...
const colorVariants: Record<ColorVariant, { outer: string; inner: string; button: string; textColor: string; textShadow: string }> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#3b0080] to-[#7c3aed]",
    inner: "bg-gradient-to-b from-[#a855f7] via-[#4c0080] to-[#c084fc]",
    button: "bg-gradient-to-b from-[#7c3aed] to-[#5b21b6]",
    textColor: "text-white",
    textShadow: "[text-shadow:_0_-1px_0_rgb(91_33_182_/_100%)]",
  },
  success: {
