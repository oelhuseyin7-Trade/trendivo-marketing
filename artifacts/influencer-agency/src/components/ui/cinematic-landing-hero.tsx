...
export function CinematicHero({
  brandName = "TRENDIVO",
  tagline1 = "Connect brands with",
  tagline2 = "creators that convert.",
  cardHeading = "Influence, engineered.",
  cardDescription = (
    <>
      <span className="text-white font-semibold">Trendivo</span> matches high-performing creators with industry-leading brands — driving real results, real reach, and real revenue.
    </>
  ),
  metricValue = 10000,
  metricLabel = "Creators",
  ctaHeading = "Ready to grow?",
  ctaDescription = "Join the most exclusive influencer network. Drive real results, reach real audiences, grow real income.",
  ctaButtons,
  className,
  ...props
}: CinematicHeroProps) {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        ...
        .to(".counter-val", { innerHTML: metricValue >= 1000 ? Math.round(metricValue / 1000) : metricValue, snap: { innerHTML: 1 }, duration: 2, ease: "expo.out" }, "-=2.0")
  ...
  return (
    ...
    >
      ...
      {/* FOREGROUND LAYER: Deep Blue Card */}
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          <span className="text-[10px] text-neutral-400 uppercase tracking-widest font-bold mb-1">Network</span>
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Dashboard</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">TM</div>
                      </div>
                      ...
                      <div className="phone-widget relative w-44 h-44 mx-auto flex items-center justify-center mb-8 drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]">
                        ...
                        <div className="text-center z-10 flex flex-col items-center">
                          <div className="flex items-end gap-0.5">
                            ...
                            {metricValue >= 1000 && <span className="text-2xl font-extrabold text-white mb-0.5">K</span>}
                          </div>
                          <span className="text-[8px] text-violet-200/50 uppercase tracking-[0.1em] font-bold mt-0.5">{metricLabel}</span>
                        </div>
                      </div>

                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-violet-500/20 to-violet-600/5 flex items-center justify-center mr-3 border border-violet-400/20 shadow-inner">
                            <svg className="w-4 h-4 text-violet-400 drop-shadow-md" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Campaign Live</p>
                    <p className="text-violet-200/50 text-[10px] lg:text-xs font-medium">Just launched</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Brand Deal Closed</p>
                    <p className="text-violet-200/50 text-[10px] lg:text-xs font-medium">Partnership secured</p>
                  </div>
                </div>
              </div>
            </div>

            {/* LEFT (Desktop) / BOTTOM (Mobile): Description Text */}
